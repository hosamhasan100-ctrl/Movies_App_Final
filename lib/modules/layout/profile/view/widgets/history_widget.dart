...
import '../../viewmodel/history_states.dart';

class HistoryMoviesWidget extends StatelessWidget {
  const HistoryMoviesWidget({super.key});
      ...
      child: BlocBuilder<HistoryCubit, HistoryState>(
        builder: (context, state) {
          switch (state) {
            ...
            case HistoryLoaded(:final movies):
              if (movies.isEmpty) {
                return Center(
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onDoubleTap: (){
            context.read<HistoryCubit>().removeFromHistory(movie.id);
          },
          onTap: () {
